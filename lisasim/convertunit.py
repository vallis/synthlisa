...
def convertUnit(param,unitin,unitout,paramname=''):
    ...
    raise NotImplementedError("convertUnit(): cannot convert {} from {} to {} (parameter {})".format(param,unitin,unitout,paramname))
...
def interp2length(interptype,interpwindow):
    if interptype == 'NearestNeighbor':
        ...
        raise NotImplementedError("convertParameters(): unknown interpolator type {}".format(interptype))
...
def length2interp(l):
    ...
    if interplen == 0.0:
        ...
        raise NotImplementedError("convertParameters(): unknown interpolator length {}".format(interplen))
    ...
    try:
        for arg in conversionRules[param[0]][0]:
            try:
                ...
                raise AttributeError("convertParameters(): need {} to return {}".format(arg[0],param[0]))
    except KeyError:
