...
setup(name = 'synthLISA',
      ...
      package_data = {'synthlisa': ['data/positions.txt','data/NGO_1M_10deg_synthlisa.txt','data/NGO_1M_closest_synthlisa.txt',
                                                         'data/NGO_1M_10deg_rev_synthlisa.txt','data/NGO_1M_closest_rev_synthlisa.txt',
                                    'data/lisa-xml.dtd',
                                    'data/lisa-xml.xsl',
