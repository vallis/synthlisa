...
plot 1;
replot "data/tdi2nd-comparison.txt" using 1:2 title 'ratio between (amplitude) S/Ns nominal-laser and no-laser X' with lines;
...
set output "eps/test-tdi2nd-logcomp.eps";
replot;
